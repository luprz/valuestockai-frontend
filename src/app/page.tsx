  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-8 pb-20 sm:p-20">
      <main className="w-full max-w-3xl flex flex-col items-center gap-4">
        ...
        <SearchInput />
        <Disclaimer text="Disclaimer: This content does not constitute investment advice; any financial decision should be based on your own analysis and consultation with qualified professionals, considering that all investments involve risks and that past performance does not guarantee future results." />
      </main>
